...
export default function HeroSection() {
  ...
  return (
    <section
      className="w-full h-[120vh] flex flex-col justify-center items-center text-center text-[#F7FFD9] bg-cover bg-center relative font-clash"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl px-2 top-5.5">
        ...
        <div className="flex flex-col">
          ...
          <h2 className="text-[6rem] md:text-[4rem] lg:text-[10rem] font-extrabold leading-none">
            {t("heading2")}
          </h2>
        </div>

        {/* Subheading */}
        <p className="text-[0.9rem] md:text-[1.5rem] lg:text-[1.75rem] text-[#C8C8C8] mb-10">
          {t("subheading")}
        </p>
