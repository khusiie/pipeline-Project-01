...
const BecomeChallenger = () => {
  ...
  return (
    <section className="bg-black text-white py-16 md:px-4">
      ...
      <div className="w-full bg-[url('/bg1.png')] bg-cover bg-center bg-zinc-800  py-8 sm:rounded-lg text-center relative ">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            <span className="text-2xl font-normal text-white tracking-wide">
              200 Total
            </span>
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-medium text-white/80 uppercase">
                Days
              </span>
            </div>
...
"
          >
            {["Hours", "Minutes", "Seconds"].map((unit, i) => {
              const value =
                [timeLeft.hours, timeLeft.minutes, timeLeft.seconds][i] ?? 0;
              return (
                <div
                  key={unit}
