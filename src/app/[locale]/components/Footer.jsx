...
export default function Footer() {
  return (
    <footer className="bg-[#121212] text-white px-4 sm:px-6 md:px-12 md:py-12 py-6 font-clash">
...
">
      ...
      <div className="md:hidden grid grid-cols-2 gap-8 max-w-md mx-auto text-center mt-12">
          ...
          <div className="flex flex-col space-y-2 py-2 px-2">
            {[
              ...
              <button
                ...
                className="bg-gray-800 hover:bg-lime-400 focus:bg-lime-400 active:bg-lime-400
                           text-white hover:text-black focus:text-black active:text-black
                           px-2 py-1 text-[10px] sm:text-xs rounded-full transition duration-300
                           sm:px-3 sm:py-1.5"
              >
                {link}
              </button>
        ...
        <div className="text-left">
          <h3 className="uppercase font-bold mb-4 flex items-center gap-2 text-sm justify-start text-left">
            <span className="h-2 w-2 rounded-full bg-lime-400"></span> Contact Us
          </h3>
          ...
          {/* Social Icons */}
          <div className="flex  mt-5 space-x-4 md:hidden">
            {[
              {
                label: "Facebook",
                path: "M22 12c0-5.522-4.477-10-10-10S2 6.478 2 12c0 4.991 3.657 9.128 8.438 9.879v-6.987h-2.54v-2.892h2.54V9.845c0-2.507 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.462h-1.26c-1.242 0-1.63.771-1.63 1.562v1.875h2.773l-.443 2.892h-2.33v6.987C18.343 21.128 22 16.991 22 12z",
