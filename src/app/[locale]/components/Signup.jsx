...
/>
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              disabled={loading}
              className="mt-4 mb-2 sm:mt-6 lg:mt-8 w-auto sm:w-auto inline-flex justify-center items-center gap-1.5 sm:gap-2 bg-[#C6FF00] text-[#1D4E00] font-medium py-1.5 sm:py-3 lg:py-3 px-3 sm:px-6 lg:px-8 rounded-md hover:bg-lime-300 transition text-xs sm:text-sm lg:text-base disabled:opacity-50  touch-manipulation"
            >
