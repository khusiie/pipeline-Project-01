...
const NextSection = () => {
  return (
     <section>
         <div className="bg-lime-400 w-full py-2 flex items-center justify-between px-4 md:px-8">
        <svg
          width="24"
          height="24"
          viewBox="0 0 41 41"
        ...
        >
          ...
          <path d="M34.8145 27.3148V35.6482" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
                 ...
                 <p className="text-black font-semibold uppercase italic text-sm md:text-base text-center" style={{ letterSpacing: '0.43em' }}>
           Real Players. Real Picks. Real Wins.
         </p>
                 <svg
           width="24"
           height="24"
